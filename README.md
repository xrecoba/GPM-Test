...
10. **Rebasing the pull-request** - I have left all my commits as is. In a normal PR I would rebase them to make my merge more readable and consistent. --> Done, the rebased branch is this [one](https://github.com/xrecoba/GPM-Test/tree/rebased).